...
class CampusControllerTest < ActionController::TestCase
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post :create, campu: { city: @campu.city, description: @campu.description, latitude: @campu.latitude, longitude: @campu.longitude, name: @campu.name, street: @campu.street, zipcode: @campu.zipcode }
    end
  ...
  test "should update campu" do
    patch :update, id: @campu, campu: { city: @campu.city, description: @campu.description, latitude: @campu.latitude, longitude: @campu.longitude, name: @campu.name, street: @campu.street, zipcode: @campu.zipcode }
    assert_redirected_to campu_path(assigns(:campu))
  end
