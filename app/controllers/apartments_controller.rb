class ApartmentsController < ApplicationController
  ...
  private
    ...
    def apartment_params
      params.require(:apartment).permit(:title, :description, :totalPrize, :street, :city, :zipcode, :user_id, :size, :rent, :additionalCost, :phase, :deposit, :apartment_type, :movein, :furnished, :internet, :parking, :rooms, :somking, :request, images_attributes: [:id, :title, :photo, :apartment_id, :_destroy])
    end
end
